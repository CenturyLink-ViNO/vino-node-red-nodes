...
exports.createServer = function createServer(details, callback) {
  ...
  if (details.schedulerHints) {
     createOptions.body['OS-SCH-HNT:scheduler_hints'] = details.schedulerHints;
  }

  if (details.blockDeviceV2) {
     createOptions.body.server['block_device_mapping_v2'] = details.blockDeviceV2;
  }
