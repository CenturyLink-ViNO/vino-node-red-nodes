/*
 * volumes.js: Instance methods for working with Volumes from Openstack Cinder (Block Storage)
 *
 * (C) 2014 Rackspace
 *      Ken Perkins
 * MIT LICENSE
...
exports.getVolume = function (volume, callback) {
  var self = this,
    volumeId = volume instanceof Object ? volume.id : volume;
...
exports.createVolume = function (options, callback) {
  ...
  if (options.volumeType) {
    createOptions.body.volume['volume_type'] =
      options.volumeType instanceof ObjectType
  ...
  if (options.imageRef) {
    createOptions.body.volume['imageRef'] = options.imageRef;
  }
...
exports.deleteVolume = function (volume, callback) {
  var volumeId = volume instanceof Object ? volume.id : volume;
