            ...
            buttons:
               {
                  ...
                  'OK': function () {
                     ...
                     newOutputParameter.parameterName = jQuery(this).find('.output-name-field').val().trim();
                     newOutputParameter.parameterType = jQuery(this).find('.output-type-field').val();
                     const key = jQuery(this).find('.output-key-field').val().trim();
                     if (/^\w+$/.test(key))
                     {
                          newOutputParameter.parameterKey = key;
                     }
                     else
                     {
