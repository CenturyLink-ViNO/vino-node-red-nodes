      ...
      let tbl1 = table.DataTable(
         {
            ...
            columns:
               [
                  {data: 'index'},
                  {data: null, title: '', render: function() { return '<button class="reorder">&#8597;</button>' }},
                  {data: 'parameterName'},
                  {
               ...
               [
                  {
                     ...
                     action: function (e, dt, node, config) {
                        inputParameterDialog.data('table', dt).data('new', true).data('userAdded', true).data('index', 0).dialog('open');
                        return false;
                     }
                  },
                  {
