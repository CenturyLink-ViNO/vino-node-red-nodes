         ...
         '</form>').dialog(
         {
                         ...
                         if (newInputDetails.parameterSource === 'node' || newInputDetails.parameterSource === 'file')
                         {
                           switch (newInputParameter.parameterType) {
                               ...
                               case 'number':
                                   ...
                                   break;
                               case 'boolean':
                                   switch (dialog.find('.parameter-input-booleanValue').val())
                                   {
                                        case '':
                                        case undefined:
                                        case null:
                                            newInputParameter.displayValue = undefined;
                                            break;
                                        case 'true':
                                            newInputParameter.displayValue = true;
                                            break;
                                        case 'false':
                                        default:
                                            newInputParameter.displayValue = false;
                                   } 
            ...
            open: function (event, ui) {
               ...
               dialog.find('.parameter-input-options').on('change', function() {
                   ...
                   enumeratedSelect.append('<option value=""></option>');
