      ...
      return jQuery(
         '<form class="add-input-parameter-dialog">' +
            ...
            '<div class="row file-select-row">' +
               ...
               '<div class="span6"><select class="input-fileSelect-field" style="width:100%;"/></div>' +
            '</div>' +
            ...
            '<div class="row input-constantsPath-field-row">' +
                ...
                '<div class="span6"><select class="input-constantsPath-field" style="width:100%;"/></div>' +
                '<div class="clearfix"/>' +
         ...
         '</form>').dialog(
         {
            ...
            open: function (event, ui) {
               ...
               dialog.find('.input-encrypt-field').on('change', function()
               {
                  ...
                  {
                     dialog.find('.parameter-value').prop('disabled', true);
                  }
                  else
                  {
                     dialog.find('.parameter-value').prop('disabled', false);
                  }
               });
